...
export const getProducts = async (
    ...
    const {data} =  await axios(`http://localhost:5000/api/${storeId}/products`)
    return data
}
...
export const getProductById = async (
    ...
    const products = await axios(`http://localhost:5000/api/${storeId}/products/${productsId}`)
...
export const createProduct = async (
    ...
    const {status} = await axios.post(`http://localhost:5000/api/${product.storeId}/products`,product)
    return status
}
...
export const updateProduct = async (
    ...
    const {status} = await axios.patch(`http://localhost:5000/api/${updatedProducts.storeId}/products/${updatedProducts.productId}`,updatedProducts)
    return status
}
...
export const deleteProduct = async (
    ...
    const {status} =  await axios.delete(`http://localhost:5000/api/${storeId}/products/${productsId}`)
    return status
}
