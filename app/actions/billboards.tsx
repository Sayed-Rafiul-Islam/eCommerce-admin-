...
export const createBillboard = async (
    ...
    const {status} = await axios.post(`hhttps://e-commerce-admin-server-seven.vercel.app/api/${billboard.storeId}/billboards`,billboard)
    return status
}
...
export const getBillboardById = async (
    ...
    const billboard = await axios(`hhttps://e-commerce-admin-server-seven.vercel.app/api/${storeId}/billboards/${billboardId}`)
...
export const getBillboards = async (
    ...
    const {data} =  await axios(`hhttps://e-commerce-admin-server-seven.vercel.app/api/${storeId}/billboards`)
    return data
}
...
export const updateBillboard = async (
    ...
    const {status} = await axios.patch(`hhttps://e-commerce-admin-server-seven.vercel.app/api/${updatedBillboard.storeId}/billboards/${updatedBillboard.billboardId}`,updatedBillboard)
    return status
}
...
export const deleteBillboard = async (
    ...
    const {status} =  await axios.delete(`hhttps://e-commerce-admin-server-seven.vercel.app/api/${storeId}/billboards/${billboardId}`)
    return status
}
